...
import input_module_axonius_adapter_fetch_history as input_module
...
'''
    ...
    Add your modular input logic to file input_module_axonius_adapter_fetch_history.py
'''
class ModInputaxonius_adapter_fetch_history(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputaxonius_adapter_fetch_history, self).__init__("ta_axonius", "axonius_adapter_fetch_history", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputaxonius_adapter_fetch_history, self).get_scheme()
        scheme.title = ("Adapter Fetch History")
...
if __name__ == "__main__":
    exitcode = ModInputaxonius_adapter_fetch_history().run(sys.argv)
    sys.exit(exitcode)
