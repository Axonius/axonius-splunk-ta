...
import input_module_axonius_saved_query_advanced as input_module
...
'''
    ...
    Add your modular input logic to file input_module_axonius_saved_query_advanced.py
'''
class ModInputaxonius_saved_query_advanced(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputaxonius_saved_query_advanced, self).__init__("ta_axonius", "axonius_saved_query_advanced", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputaxonius_saved_query_advanced, self).get_scheme()
        scheme.title = ("Axonius Saved Query (Advanced)")
...
if __name__ == "__main__":
    exitcode = ModInputaxonius_saved_query_advanced().run(sys.argv)
    sys.exit(exitcode)
